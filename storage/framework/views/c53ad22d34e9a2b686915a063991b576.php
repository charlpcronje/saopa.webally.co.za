                ...
                <div class="flex flex-wrap -mx-3"> <!-- Added for two-column layout -->
                    <div class="w-full md:w-1/2 px-3 mb-4"> <!-- Column 1 -->
                        <div class="mb-4 flex justify-center">
                            <input id="name" type="text" name="name" value="<?php echo e(old('name')); ?>" required autofocus placeholder="Name" class="input-field <?php $__errorArgs = ['name'];
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4 flex justify-center">
                            <input id="surname" type="text" name="surname" value="<?php echo e(old('surname')); ?>" required placeholder="Surname" class="input-field <?php $__errorArgs = ['surname'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4 flex justify-center">
                            <input id="company" type="text" name="company" value="<?php echo e(old('company')); ?>" required placeholder="Company" class="input-field <?php $__errorArgs = ['company'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="w-full md:w-1/2 px-3"> <!-- Column 2 -->
                        <div class="mb-4 flex justify-center">
                            <input id="mobile_number" type="text" name="mobile_number" value="<?php echo e(old('mobile_number')); ?>" required placeholder="Mobile Number" class="input-field <?php $__errorArgs = ['mobile_number'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4 flex justify-center">
                            <input id="email" type="email" name="email" value="<?php echo e(old('email')); ?>" required placeholder="Email" class="input-field <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4 flex justify-center">
                            <input id="password" type="password" name="password" required placeholder="Password" class="input-field <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
<?php endif; ?>
                ...
                <div class="flex flex-col items-start text-sm">
                    <a href="<?php echo e(route('login')); ?>" class="link-register font-semibold hover:underline"><?php echo e(__('Already have an account? Login')); ?></a>
                </div>
            </form>
        </div>
    </div>
...
<?php endif; ?>
<?php /**PATH /var/www/html/sapoa.webally.co.za/resources/views/auth/register.blade.php ENDPATH**/ ?>